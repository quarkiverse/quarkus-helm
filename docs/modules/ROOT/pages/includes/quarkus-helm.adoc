...
a|icon:lock[title=Fixed at build time] [[quarkus-helm_quarkus.helm.dependencies.-dependencies-.wait-for-service-command-template]]`link:#quarkus-helm_quarkus.helm.dependencies.-dependencies-.wait-for-service-command-template[quarkus.helm.dependencies."dependencies".wait-for-service-command-template]`
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_HELM_DEPENDENCIES__DEPENDENCIES__WAIT_FOR_SERVICE_COMMAND_TEMPLATE+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_HELM_DEPENDENCIES__DEPENDENCIES__WAIT_FOR_SERVICE_COMMAND_TEMPLATE+++`
endif::add-copy-button-to-env-var[]
--|string 
|`for i in $(seq 1 200); do nc -z -w3 ::service-name && exit 0 \|\| sleep 3; done; exit 1`
